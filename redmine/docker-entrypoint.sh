...
#customize after here↓

# copy redmine's directory to local host directory
cp -r /usr/src/redmine /var/www/html

#change owner/group of specific redmine's directory from 999(Redmine default-user/group) to www-data(Nginx default-user/group)
